...
export function NavLink({
  ...
  return (
    ...
    >
       ...
       * requirement — which is why the top-edge line is mounted from inside
       * each nav link rather than once at the layout. It renders nothing at
       * all unless a navigation from *this* link is pending.
       */}
      <NavigationProgress />
    </Link>
  );
