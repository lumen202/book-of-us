  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-6 pb-24 pt-8">
      ...
      <header className="flex flex-col gap-2">
        <span className="text-[11px] uppercase tracking-[0.3em] text-accent">Keeper only</span>
        <h1 className="font-serif text-4xl leading-tight text-ink">Removed photos</h1>
